...
final class AutomationTests: XCTestCase {
    ...
    func testAutomationCatalogURLExamplesStayParseable() throws {
        ...
        let examples: [(String, SunclubAutomationAction)] = [
            ...
            ("sunclub://automation/open?route=uv-forecast", .open(.uvForecast)),
            ("sunclub://automation/open?route=privacy", .open(.privacy)),
            ("sunclub://automation/open?route=support", .open(.support)),
