...
| CG-041..CG-055 | Implemented | Rewrote privacy/support home panels, retained the support, privacy, security, and contact mailboxes at `mail.sunclub.peyton.app`, made iCloud optional, removed heavy footer treatment, and used local imagery with explicit dimensions and decoding/loading hints. |
